...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { base_price: @price.base_price, category: @price.category, km_price: @price.km_price }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { base_price: @price.base_price, category: @price.category, km_price: @price.km_price }
    assert_redirected_to price_path(assigns(:price))
  end
